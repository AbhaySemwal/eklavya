  ...
  return (
    <div>
      <div style={{backgroundImage: "url('/laser.jpg')"}} className='bg-cover'>
        <div className='mx-auto w-5/6 py-36'>
          <div className='flex justify-between items-center'>
            <div className='flex flex-col gap-16 w-5/12 px-8'>
              ...
              <div className='flex gap-5'>
                <button className='p-3 bg-blue-500 text-white rounded-xl font-medium hover:bg-blue-600'>Get Started</button>
                {/* Button to open the modal */}
                <button className='p-3 border-2 border-blue-500 rounded-xl font-medium' onClick={toggleModal}>Watch Demo</button>
              </div>
            </div>
          </div>
        </div>
